...
public class PortfolioReport {
	...
	public static void main(String[] args) {
		...
		for(PortfolioString x: portfolioStringArray) {
			...
			System.out.printf("%-80s",String.format("%s, %s",x.getpManagerLast(), x.getpManagerFirst()));
			System.out.printf("$ %12.4f", x.getpRisk());
			System.out.printf("$ %12.2f", x.getpReturns());
			System.out.printf("$ %12.2f", x.getpValue());			
			System.out.printf("\n");
		}
		System.out.println("                                                     -------------------------------------------------------------------------");
		System.out.printf("                                              Totals $     2700.00  $    23146.11                 $   %.2f  $  %.2f", totalAnnualReturn, totalValue);
